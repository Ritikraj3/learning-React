        ...
        <img src={countryData.flag} alt={`${countryData.name} flag`} />
         <div className="details-text-container">
           ...
           <div className="details-text">
             ...
             <p><b>Top Level Domain: {countryData.domain} </b><span className="domain"></span></p>
             <p><b>Currencies: {countryData.currencies} </b><span className="currency"></span></p>
             <p><b>Languages: {countryData.languages} </b><span className="language"></span></p>
           </div>
